...
def add_underwater_effect(frame, bubbles, bubble_png):
...
bubble_png = cv2.imread('gelembungg.png', cv2.IMREAD_UNCHANGED)  # Ensure the image has an alpha channel
...
while True:
    ...
    underwater_frame = add_underwater_effect(frame, bubbles, bubble_png)
